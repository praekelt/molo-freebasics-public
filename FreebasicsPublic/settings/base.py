"""
Django settings for base FreebasicsPublic.
...
SECRET_KEY = "3ge2^pq2pna586l__k07()(ho2kr4lvf2htyy-+yev=eokxe3+"
...
ROOT_URLCONF = 'FreebasicsPublic.urls'
WSGI_APPLICATION = 'FreebasicsPublic.wsgi.application'
